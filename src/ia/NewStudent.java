...
public class NewStudent extends JFrame {
	...
	private JLabel titletext = new JLabel("New Student");
	
	private JLabel uName = new JLabel("Username: ");
	private JLabel pWord = new JLabel("Password: ");
	private JLabel cpWord = new JLabel("Confirm Password: ");
	private JLabel taken = new JLabel("This username is taken");
	private JLabel mismatch = new JLabel("The passwords do not match");
	private JLabel success = new JLabel("Success! The student has been added.");
	...
	public NewStudent(Controller c) {
